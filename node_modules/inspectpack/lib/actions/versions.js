...
const createEmptyData = () => ({
    assets: {},
    meta: Object.assign(Object.assign({}, createEmptyMeta()), { commonRoot: null, packageRoots: [] }),
});
    ...
    _getData() {
        ...
        return exports._packageRoots(mods).then((pkgRoots) => {
            ...
            return promise_1.serial(pkgRoots.map((pkgRoot) => () => dependencies_1.dependencies(pkgRoot, pkgsFilter, pkgMap)))
                ...
                const data = Object.assign(Object.assign({}, createEmptyData()), { assets: assetNames.reduce((memo, assetName) => (Object.assign(Object.assign({}, memo), { [assetName]: getAssetData(commonRoot, allDeps, assets[assetName].mods) })), {}) });
